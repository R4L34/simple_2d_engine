package com.r4l.r4ls_2d_engine.event.events;
...
public class EngineMouseEvent {
    ...
    @SuppressWarnings("serial")
	public static class Clicked extends Base {
        public Clicked(MouseEvent e, Screen screen) {
            super(e, screen);
        }
    }
    ...
    @SuppressWarnings("serial")
	public static class Entered extends Base {
        public Entered(MouseEvent e, Screen screen) {
            super(e, screen);
        }
    }

    @SuppressWarnings("serial")
	public static class Exited extends Base {
        public Exited(MouseEvent e, Screen screen) {
            super(e, screen);
        }
    }
